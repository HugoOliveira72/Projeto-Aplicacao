<?php 
    Class doacao{
        ...
        $complemento_recebedor,$cidade_recebedor,$uf_recebedor,$pais_recebedor,$cep_recebedor,$data_doacao){
            ...
            global $pdo;
                ...
                ds_data) VALUES (:iu,:do,:ir,:r,:emr,:emd,:vld,:chp,:itd,:endr,:nendr,:bar,:cor,:cir,:ufr,:par,:cer,:dt)");
        ...
        public function historico_recebedor(){ //selet a partir do id_recebedor
            global $pdo;

            $sql = $pdo->prepare("SELECT (id_Doador,ds_Doador,id_Recebedor,ds_Recebedor,
                ds_EmailRecebedor,ds_EmailDoador,vl_Doacao,ds_ChavePix,ds_ItemDoado,ds_EnderecoRecebedor,nr_EnderecoRecebedor,
                ds_BairroRecebedor,ds_ComplementoRecebedor,ds_CidadeRecebedor,cd_UF_Recebedor,ds_PaisRecebedor,cd_CEP_Recebedor,
                ds_data) FROM tbddoacao WHERE ");
        }
    }
?>